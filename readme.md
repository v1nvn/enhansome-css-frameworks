...
Feel free to [contribute](https://github.com/troxler/awesome-css-frameworks/blob/master/.github/CONTRIBUTING.md) ⭐ 9,357 | 🐛 3 | 🌐 CSS | 📅 2026-04-11.
...
* [**Pico.css**](https://picocss.com/) - Elegant styles for all native HTML elements, dark mode automatically enabled.\
  ...
  [Repo](https://github.com/picocss/pico) ⭐ 16,621 | 🐛 124 | 🌐 CSS | 📅 2026-05-09
  \| #SCSS
...
* [**Bootstrap**](https://getbootstrap.com) - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.\
  ...
  [Repo](https://github.com/twbs/bootstrap) ⭐ 174,277 | 🐛 440 | 🌐 MDX | 📅 2026-05-27
  \| #SCSS
...
* [**UIkit**](https://getuikit.com) - Lightweight and modular front-end framework for developing fast and powerful web interfaces.\
  ...
  [Repo](https://github.com/uikit/uikit) ⭐ 18,537 | 🐛 606 | 🌐 HTML | 📅 2026-05-28
  \| #LESS #SCSS
...
* [**Carbon Components**](https://www.carbondesignsystem.com/) - Component library behind IBM's Carbon Design System.\
  ...
  [Repo](https://github.com/carbon-design-system/carbon) ⭐ 9,143 | 🐛 992 | 🌐 JavaScript | 📅 2026-05-28
  \| #SCSS
...
* [**Beer CSS**](https://www.beercss.com) - Build material design interfaces in record time without stress for devs.\
  ...
  [Repo](https://github.com/beercss/beercss) ⭐ 2,331 | 🐛 31 | 🌐 Vue | 📅 2026-05-25
  \| #CSS
...
* [**Tailwind CSS**](https://tailwindcss.com) - Utility-first CSS framework for rapid UI development.\
  ...
  [Repo](https://github.com/tailwindlabs/tailwindcss) ⭐ 95,147 | 🐛 88 | 🌐 TypeScript | 📅 2026-05-28
  \| #CSS
...
* [**98.css**](https://jdan.github.io/98.css/) - CSS library for building interfaces that look like Windows 98.\
  ...
  [Repo](https://github.com/jdan/98.css) ⭐ 11,082 | 🐛 41 | 🌐 CSS | 📅 2025-09-07
  \| #CSS
...
* [**XP.css**](https://botoxparty.github.io/XP.css/) - CSS library for building interfaces that look like Windows XP.\
  ...
  [Repo](https://github.com/botoxparty/XP.css) ⭐ 2,971 | 🐛 24 | 🌐 SCSS | 📅 2025-03-08
  \| #PostCSS
...
Images of GitHub stars are provided by [Shields](https://github.com/badges/shields) ⭐ 26,690 | 🐛 324 | 🌐 JavaScript | 📅 2026-05-26.
